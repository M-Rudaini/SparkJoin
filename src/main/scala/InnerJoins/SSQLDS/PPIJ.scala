...
//  Initializing the DS Post-Processed Inner-Join.
object PPIJ {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // loading Purchase Dataset using the Products Case Class and Schema...
    // Considering the header as Column Names that will be used later...
    ...
    val UserPurchase = InUserDS.join(InPurchseDS,"User_ID")
      .persist()  // Caching the joined Dataset for further use.
    ...
    // -Aggregating and summing all grouped values as "Total_Purchase".
